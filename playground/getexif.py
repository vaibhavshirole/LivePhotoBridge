...
if __name__ == '__main__':
    ...
    if parsed_args.file:
        if os.path.exists(parsed_args.file):
            ...
            basename = os.path.basename(parsed_args.file)
            extension = basename.split('.')[1]

            output_file = os.path.join(output_directory, os.path.splitext(os.path.basename(parsed_args.file))[0] + os.path.splitext(parsed_args.file)[1] + '_exif.txt')
